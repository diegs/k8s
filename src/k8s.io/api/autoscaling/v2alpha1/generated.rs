...
impl HorizontalPodAutoscaler {
    ...
    // optional .k8s.io.api.autoscaling.v2alpha1.HorizontalPodAutoscalerSpec spec = 2;
    ...
    // optional .k8s.io.api.autoscaling.v2alpha1.HorizontalPodAutoscalerStatus status = 3;
...
impl HorizontalPodAutoscalerList {
    ...
    // repeated .k8s.io.api.autoscaling.v2alpha1.HorizontalPodAutoscaler items = 2;
...
pub struct HorizontalPodAutoscalerSpec {
    ...
    metrics: ::protobuf::RepeatedField<MetricSpec>,
    // special fields
    unknown_fields: ::protobuf::UnknownFields,
    cached_size: ::protobuf::CachedSize,
}
...
impl HorizontalPodAutoscalerSpec {
    ...
    // optional .k8s.io.api.autoscaling.v2alpha1.CrossVersionObjectReference scaleTargetRef = 1;
    ...
    // repeated .k8s.io.api.autoscaling.v2alpha1.MetricSpec metrics = 4;
    ...
    // Param is passed by value, moved
    pub fn set_metrics(&mut self, v: ::protobuf::RepeatedField<MetricSpec>) {
        self.metrics = v;
    }

    // Mutable pointer to the field.
    pub fn mut_metrics(&mut self) -> &mut ::protobuf::RepeatedField<MetricSpec> {
        &mut self.metrics
    }

    // Take field
    pub fn take_metrics(&mut self) -> ::protobuf::RepeatedField<MetricSpec> {
        ::std::mem::replace(&mut self.metrics, ::protobuf::RepeatedField::new())
    }

    pub fn get_metrics(&self) -> &[MetricSpec] {
        &self.metrics
    }

    fn get_metrics_for_reflect(&self) -> &::protobuf::RepeatedField<MetricSpec> {
        &self.metrics
    }

    fn mut_metrics_for_reflect(&mut self) -> &mut ::protobuf::RepeatedField<MetricSpec> {
        &mut self.metrics
    }
}
    ...
    fn descriptor_static(_: ::std::option::Option<HorizontalPodAutoscalerSpec>) -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_repeated_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<MetricSpec>>(
                    "metrics",
                    HorizontalPodAutoscalerSpec::get_metrics_for_reflect,
                    HorizontalPodAutoscalerSpec::mut_metrics_for_reflect,
                ));
...
pub struct HorizontalPodAutoscalerStatus {
    ...
    currentMetrics: ::protobuf::RepeatedField<MetricStatus>,
    conditions: ::protobuf::RepeatedField<HorizontalPodAutoscalerCondition>,
    // special fields
    unknown_fields: ::protobuf::UnknownFields,
    cached_size: ::protobuf::CachedSize,
}
...
impl HorizontalPodAutoscalerStatus {
    ...
    // repeated .k8s.io.api.autoscaling.v2alpha1.MetricStatus currentMetrics = 5;
    ...
    // Param is passed by value, moved
    pub fn set_currentMetrics(&mut self, v: ::protobuf::RepeatedField<MetricStatus>) {
        self.currentMetrics = v;
    }

    // Mutable pointer to the field.
    pub fn mut_currentMetrics(&mut self) -> &mut ::protobuf::RepeatedField<MetricStatus> {
        &mut self.currentMetrics
    }

    // Take field
    pub fn take_currentMetrics(&mut self) -> ::protobuf::RepeatedField<MetricStatus> {
        ::std::mem::replace(&mut self.currentMetrics, ::protobuf::RepeatedField::new())
    }

    pub fn get_currentMetrics(&self) -> &[MetricStatus] {
        &self.currentMetrics
    }

    fn get_currentMetrics_for_reflect(&self) -> &::protobuf::RepeatedField<MetricStatus> {
        &self.currentMetrics
    }

    fn mut_currentMetrics_for_reflect(&mut self) -> &mut ::protobuf::RepeatedField<MetricStatus> {
        &mut self.currentMetrics
    }

    // repeated .k8s.io.api.autoscaling.v2alpha1.HorizontalPodAutoscalerCondition conditions = 6;
    ...
    // Param is passed by value, moved
    pub fn set_conditions(&mut self, v: ::protobuf::RepeatedField<HorizontalPodAutoscalerCondition>) {
        self.conditions = v;
    }

    // Mutable pointer to the field.
    pub fn mut_conditions(&mut self) -> &mut ::protobuf::RepeatedField<HorizontalPodAutoscalerCondition> {
        &mut self.conditions
    }

    // Take field
    pub fn take_conditions(&mut self) -> ::protobuf::RepeatedField<HorizontalPodAutoscalerCondition> {
        ::std::mem::replace(&mut self.conditions, ::protobuf::RepeatedField::new())
    }

    pub fn get_conditions(&self) -> &[HorizontalPodAutoscalerCondition] {
        &self.conditions
    }

    fn get_conditions_for_reflect(&self) -> &::protobuf::RepeatedField<HorizontalPodAutoscalerCondition> {
        &self.conditions
    }

    fn mut_conditions_for_reflect(&mut self) -> &mut ::protobuf::RepeatedField<HorizontalPodAutoscalerCondition> {
        &mut self.conditions
    }
}
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                5 => {
                    ::protobuf::rt::read_repeated_message_into(wire_type, is, &mut self.currentMetrics)?;
                },
                6 => {
    ...
    fn descriptor_static(_: ::std::option::Option<HorizontalPodAutoscalerStatus>) -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_repeated_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<MetricStatus>>(
                    "currentMetrics",
                    HorizontalPodAutoscalerStatus::get_currentMetrics_for_reflect,
                    HorizontalPodAutoscalerStatus::mut_currentMetrics_for_reflect,
                ));
                fields.push(::protobuf::reflect::accessor::make_repeated_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<HorizontalPodAutoscalerCondition>>(
                    "conditions",
                    HorizontalPodAutoscalerStatus::get_conditions_for_reflect,
                    HorizontalPodAutoscalerStatus::mut_conditions_for_reflect,
                ));
...
impl MetricSpec {
    ...
    // optional .k8s.io.api.autoscaling.v2alpha1.ObjectMetricSource object = 2;
    ...
    // optional .k8s.io.api.autoscaling.v2alpha1.PodsMetricSource pods = 3;
    ...
    // optional .k8s.io.api.autoscaling.v2alpha1.ResourceMetricSource resource = 4;
...
impl MetricStatus {
    ...
    // optional .k8s.io.api.autoscaling.v2alpha1.ObjectMetricStatus object = 2;
    ...
    // optional .k8s.io.api.autoscaling.v2alpha1.PodsMetricStatus pods = 3;
    ...
    // optional .k8s.io.api.autoscaling.v2alpha1.ResourceMetricStatus resource = 4;
...
impl ObjectMetricSource {
    ...
    // optional .k8s.io.api.autoscaling.v2alpha1.CrossVersionObjectReference target = 1;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n/k8s.io/api/autoscaling/v2alpha1/generated.proto\x12\x1fk8s.io.api.aut\
    oscaling.v2alpha1\x1a)k8s.io/api/autoscaling/v1/generated.proto\x1a\"k8s\
    .io/api/core/v1/generated.proto\x1a4k8s.io/apimachinery/pkg/api/resource\
    /generated.proto\x1a4k8s.io/apimachinery/pkg/apis/meta/v1/generated.prot\
    o\x1a/k8s.io/apimachinery/pkg/runtime/generated.proto\x1a6k8s.io/apimach\
    inery/pkg/runtime/schema/generated.proto\x1a3k8s.io/apimachinery/pkg/uti\
    l/intstr/generated.proto\"e\n\x1bCrossVersionObjectReference\x12\x12\n\
    ...
    \x0b20.k8s.io.apimachinery.pkg.apis.meta.v1.ObjectMetaR\x08metadata\x12P\
    \n\x04spec\x18\x02\x20\x01(\x0b2<.k8s.io.api.autoscaling.v2alpha1.Horizo\
    ntalPodAutoscalerSpecR\x04spec\x12V\n\x06status\x18\x03\x20\x01(\x0b2>.k\
    8s.io.api.autoscaling.v2alpha1.HorizontalPodAutoscalerStatusR\x06status\
    \"\xdc\x01\n\x20HorizontalPodAutoscalerCondition\x12\x12\n\x04type\x18\
    \x01\x20\x01(\tR\x04type\x12\x16\n\x06status\x18\x02\x20\x01(\tR\x06stat\
    us\x12Z\n\x12lastTransitionTime\x18\x03\x20\x01(\x0b2*.k8s.io.apimachine\
    ry.pkg.apis.meta.v1.TimeR\x12lastTransitionTime\x12\x16\n\x06reason\x18\
    ...
    tadata\x12N\n\x05items\x18\x02\x20\x03(\x0b28.k8s.io.api.autoscaling.v2a\
    lpha1.HorizontalPodAutoscalerR\x05items\"\x8e\x02\n\x1bHorizontalPodAuto\
    scalerSpec\x12d\n\x0escaleTargetRef\x18\x01\x20\x01(\x0b2<.k8s.io.api.au\
    toscaling.v2alpha1.CrossVersionObjectReferenceR\x0escaleTargetRef\x12\
    \x20\n\x0bminReplicas\x18\x02\x20\x01(\x05R\x0bminReplicas\x12\x20\n\x0b\
    maxReplicas\x18\x03\x20\x01(\x05R\x0bmaxReplicas\x12E\n\x07metrics\x18\
    \x04\x20\x03(\x0b2+.k8s.io.api.autoscaling.v2alpha1.MetricSpecR\x07metri\
    cs\"\xaf\x03\n\x1dHorizontalPodAutoscalerStatus\x12.\n\x12observedGenera\
    tion\x18\x01\x20\x01(\x03R\x12observedGeneration\x12P\n\rlastScaleTime\
    \x18\x02\x20\x01(\x0b2*.k8s.io.apimachinery.pkg.apis.meta.v1.TimeR\rlast\
    ScaleTime\x12(\n\x0fcurrentReplicas\x18\x03\x20\x01(\x05R\x0fcurrentRepl\
    icas\x12(\n\x0fdesiredReplicas\x18\x04\x20\x01(\x05R\x0fdesiredReplicas\
    \x12U\n\x0ecurrentMetrics\x18\x05\x20\x03(\x0b2-.k8s.io.api.autoscaling.\
    v2alpha1.MetricStatusR\x0ecurrentMetrics\x12a\n\nconditions\x18\x06\x20\
    \x03(\x0b2A.k8s.io.api.autoscaling.v2alpha1.HorizontalPodAutoscalerCondi\
    tionR\nconditions\"\x87\x02\n\nMetricSpec\x12\x12\n\x04type\x18\x01\x20\
    \x01(\tR\x04type\x12K\n\x06object\x18\x02\x20\x01(\x0b23.k8s.io.api.auto\
    scaling.v2alpha1.ObjectMetricSourceR\x06object\x12E\n\x04pods\x18\x03\
    \x20\x01(\x0b21.k8s.io.api.autoscaling.v2alpha1.PodsMetricSourceR\x04pod\
    s\x12Q\n\x08resource\x18\x04\x20\x01(\x0b25.k8s.io.api.autoscaling.v2alp\
    ha1.ResourceMetricSourceR\x08resource\"\x89\x02\n\x0cMetricStatus\x12\
    \x12\n\x04type\x18\x01\x20\x01(\tR\x04type\x12K\n\x06object\x18\x02\x20\
    \x01(\x0b23.k8s.io.api.autoscaling.v2alpha1.ObjectMetricStatusR\x06objec\
    t\x12E\n\x04pods\x18\x03\x20\x01(\x0b21.k8s.io.api.autoscaling.v2alpha1.\
    PodsMetricStatusR\x04pods\x12Q\n\x08resource\x18\x04\x20\x01(\x0b25.k8s.\
    io.api.autoscaling.v2alpha1.ResourceMetricStatusR\x08resource\"\xdc\x01\
    \n\x12ObjectMetricSource\x12T\n\x06target\x18\x01\x20\x01(\x0b2<.k8s.io.\
    api.autoscaling.v2alpha1.CrossVersionObjectReferenceR\x06target\x12\x1e\
    \n\nmetricName\x18\x02\x20\x01(\tR\nmetricName\x12P\n\x0btargetValue\x18\
    \x03\x20\x01(\x0b2..k8s.io.apimachinery.pkg.api.resource.QuantityR\x0bta\
    rgetValue\"\xde\x01\n\x12ObjectMetricStatus\x12T\n\x06target\x18\x01\x20\
    \x01(\x0b2<.k8s.io.api.autoscaling.v2alpha1.CrossVersionObjectReferenceR\
    \x06target\x12\x1e\n\nmetricName\x18\x02\x20\x01(\tR\nmetricName\x12R\n\
    \x0ccurrentValue\x18\x03\x20\x01(\x0b2..k8s.io.apimachinery.pkg.api.reso\
    urce.QuantityR\x0ccurrentValue\"\x92\x01\n\x10PodsMetricSource\x12\x1e\n\
    \nmetricName\x18\x01\x20\x01(\tR\nmetricName\x12^\n\x12targetAverageValu\
    e\x18\x02\x20\x01(\x0b2..k8s.io.apimachinery.pkg.api.resource.QuantityR\
    \x12targetAverageValue\"\x94\x01\n\x10PodsMetricStatus\x12\x1e\n\nmetric\
    Name\x18\x01\x20\x01(\tR\nmetricName\x12`\n\x13currentAverageValue\x18\
    \x02\x20\x01(\x0b2..k8s.io.apimachinery.pkg.api.resource.QuantityR\x13cu\
    rrentAverageValue\"\xc6\x01\n\x14ResourceMetricSource\x12\x12\n\x04name\
    \x18\x01\x20\x01(\tR\x04name\x12:\n\x18targetAverageUtilization\x18\x02\
    \x20\x01(\x05R\x18targetAverageUtilization\x12^\n\x12targetAverageValue\
    \x18\x03\x20\x01(\x0b2..k8s.io.apimachinery.pkg.api.resource.QuantityR\
    \x12targetAverageValue\"\xca\x01\n\x14ResourceMetricStatus\x12\x12\n\x04\
    name\x18\x01\x20\x01(\tR\x04name\x12<\n\x19currentAverageUtilization\x18\
    \x02\x20\x01(\x05R\x19currentAverageUtilization\x12`\n\x13currentAverage\
    Value\x18\x03\x20\x01(\x0b2..k8s.io.apimachinery.pkg.api.resource.Quanti\
    tyR\x13currentAverageValueB\nZ\x08v2alpha1\
";
