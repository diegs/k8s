...
impl SubjectAccessReviewSpec {
    ...
    // repeated .k8s.io.api.authorization.v1.SubjectAccessReviewSpec.ExtraEntry extra = 5;
    ...
    fn descriptor_static(_: ::std::option::Option<SubjectAccessReviewSpec>) -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_repeated_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                    "groups",
                    SubjectAccessReviewSpec::get_groups_for_reflect,
                    SubjectAccessReviewSpec::mut_groups_for_reflect,
                ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n+k8s.io/api/authorization/v1/generated.proto\x12\x1bk8s.io.api.authori\
    zation.v1\x1a4k8s.io/apimachinery/pkg/apis/meta/v1/generated.proto\x1a/k\
    8s.io/apimachinery/pkg/runtime/generated.proto\x1a6k8s.io/apimachinery/p\
    kg/runtime/schema/generated.proto\x1a3k8s.io/apimachinery/pkg/util/intst\
    ...
    \x08metadata\x12H\n\x04spec\x18\x02\x20\x01(\x0b24.k8s.io.api.authorizat\
    ion.v1.SubjectAccessReviewSpecR\x04spec\x12N\n\x06status\x18\x03\x20\x01\
    (\x0b26.k8s.io.api.authorization.v1.SubjectAccessReviewStatusR\x06status\
    \"?\n\x15NonResourceAttributes\x12\x12\n\x04path\x18\x01\x20\x01(\tR\x04\
    path\x12\x12\n\x04verb\x18\x02\x20\x01(\tR\x04verb\"\xc8\x01\n\x12Resour\
    ceAttributes\x12\x1c\n\tnamespace\x18\x01\x20\x01(\tR\tnamespace\x12\x12\
    \n\x04verb\x18\x02\x20\x01(\tR\x04verb\x12\x14\n\x05group\x18\x03\x20\
    \x01(\tR\x05group\x12\x18\n\x07version\x18\x04\x20\x01(\tR\x07version\
    \x12\x1a\n\x08resource\x18\x05\x20\x01(\tR\x08resource\x12\x20\n\x0bsubr\
    esource\x18\x06\x20\x01(\tR\x0bsubresource\x12\x12\n\x04name\x18\x07\x20\
    \x01(\tR\x04name\"\x85\x02\n\x17SelfSubjectAccessReview\x12L\n\x08metada\
    ta\x18\x01\x20\x01(\x0b20.k8s.io.apimachinery.pkg.apis.meta.v1.ObjectMet\
    aR\x08metadata\x12L\n\x04spec\x18\x02\x20\x01(\x0b28.k8s.io.api.authoriz\
    ation.v1.SelfSubjectAccessReviewSpecR\x04spec\x12N\n\x06status\x18\x03\
    \x20\x01(\x0b26.k8s.io.api.authorization.v1.SubjectAccessReviewStatusR\
    \x06status\"\xe8\x01\n\x1bSelfSubjectAccessReviewSpec\x12_\n\x12resource\
    Attributes\x18\x01\x20\x01(\x0b2/.k8s.io.api.authorization.v1.ResourceAt\
    tributesR\x12resourceAttributes\x12h\n\x15nonResourceAttributes\x18\x02\
    \x20\x01(\x0b22.k8s.io.api.authorization.v1.NonResourceAttributesR\x15no\
    nResourceAttributes\"\xfd\x01\n\x13SubjectAccessReview\x12L\n\x08metadat\
    a\x18\x01\x20\x01(\x0b20.k8s.io.apimachinery.pkg.apis.meta.v1.ObjectMeta\
    R\x08metadata\x12H\n\x04spec\x18\x02\x20\x01(\x0b24.k8s.io.api.authoriza\
    tion.v1.SubjectAccessReviewSpecR\x04spec\x12N\n\x06status\x18\x03\x20\
    \x01(\x0b26.k8s.io.api.authorization.v1.SubjectAccessReviewStatusR\x06st\
    atus\"\xca\x03\n\x17SubjectAccessReviewSpec\x12_\n\x12resourceAttributes\
    \x18\x01\x20\x01(\x0b2/.k8s.io.api.authorization.v1.ResourceAttributesR\
    \x12resourceAttributes\x12h\n\x15nonResourceAttributes\x18\x02\x20\x01(\
    \x0b22.k8s.io.api.authorization.v1.NonResourceAttributesR\x15nonResource\
    Attributes\x12\x12\n\x04verb\x18\x03\x20\x01(\tR\x04verb\x12\x16\n\x06gr\
    oups\x18\x04\x20\x03(\tR\x06groups\x12U\n\x05extra\x18\x05\x20\x03(\x0b2\
    ?.k8s.io.api.authorization.v1.SubjectAccessReviewSpec.ExtraEntryR\x05ext\
    ra\x1aa\n\nExtraEntry\x12\x10\n\x03key\x18\x01\x20\x01(\tR\x03key\x12=\n\
    \x05value\x18\x02\x20\x01(\x0b2'.k8s.io.api.authorization.v1.ExtraValueR\
    \x05value:\x028\x01\"w\n\x19SubjectAccessReviewStatus\x12\x18\n\x07allow\
    ed\x18\x01\x20\x01(\x08R\x07allowed\x12\x16\n\x06reason\x18\x02\x20\x01(\
    \tR\x06reason\x12(\n\x0fevaluationError\x18\x03\x20\x01(\tR\x0fevaluatio\
    nErrorB\x04Z\x02v1\
";
